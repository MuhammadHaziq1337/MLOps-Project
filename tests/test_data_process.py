...
class TestDataProcess(TestCase):
    ...
    def test_get_dataset_california_housing(self, mock_fetch_housing):
        ...
        assert os.path.exists(
            os.path.join(output_dir, "california_housing.csv")
        )
    ...
    def test_process_data(self, mock_split_data, mock_clean_data):
        ...
        assert os.path.exists(
            os.path.join(output_dir, "test_dataset_X_train.csv")
        )
        assert os.path.exists(
            os.path.join(output_dir, "test_dataset_X_test.csv")
        )
        assert os.path.exists(
            os.path.join(output_dir, "test_dataset_y_train.csv")
        )
        assert os.path.exists(
            os.path.join(output_dir, "test_dataset_y_test.csv")
        )
