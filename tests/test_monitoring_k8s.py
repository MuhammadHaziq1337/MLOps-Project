...
class TestMonitoringK8s(unittest.TestCase):
    ...
    def test_prometheus_k8s_yaml(self):
        ...
        try:
            ...
            self.assertIsNotNone(
                prometheus_config, "Prometheus ConfigMap not found"
            )
            ...
            self.fail(
                f"Failed to validate Prometheus Kubernetes deployment: "
                f"{str(e)}"
            )
    ...
    def test_grafana_k8s_yaml(self):
        ...
        try:
            ...
            self.assertIsNotNone(
                grafana_deployment, "Grafana Deployment not found"
            )
            container_specs = (
            ...
            self.fail(
                f"Failed to validate Grafana Kubernetes deployment: {str(e)}"
            )
